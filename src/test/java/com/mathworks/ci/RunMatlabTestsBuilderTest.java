...
public class RunMatlabTestsBuilderTest {
    ...
    private static final String VERSION_INFO_XML_FILE = "VersionInfo.xml";
     ...
     */
    @Test
    public void verifyBuildStepWithMatlabTestBuilder() {
        boolean found = false;
    ...
    public void verifyLoggingLevelSet() throws Exception {
        ...
        project.getBuildWrappersList().add(this.buildWrapper);
        Map<String, String> loggingLevel = new HashMap<>();
    ...
    public void verifyOutputDetailSet() throws Exception {
        ...
        Map<String, String> outputDetail = new HashMap<>();
