...
public class RunMatlabTestsBuilderUnitTest {
        ...
        public void shouldHandleNullCases() throws IOException, InterruptedException, MatlabExecutionException {
            ...
            assertNull(actual.getTestResultsPDF());
            assertNull(actual.getTestResultsTAP());
            assertNull(actual.getTestResultsJUnit());
            assertNull(actual.getCodeCoverageCobertura());
            assertNull(actual.getTestResultsSimulinkTest());
            assertNull(actual.getModelCoverageCobertura());
            assertNull(actual.getSelectByTag());
            assertNull(actual.getLoggingLevel());
            assertNull(actual.getOutputDetail());
                assertEquals("false", actual.getUseParallel());
                assertEquals("false", actual.getStrict());
            assertNull(actual.getSourceFolder());
            assertNull(actual.getSelectByFolder());
                verify(action).run();
        }
        ...
        public void shouldHandleMaximalCases() throws IOException, InterruptedException, MatlabExecutionException {
                ...
                ArrayList<SourceFolderPaths> source = new ArrayList<>();
                source.add(new SourceFolderPaths("toolbox"));
                source.add(new SourceFolderPaths("src"));

                ArrayList<TestFolders> select = new ArrayList<>();
