...
public class TestMessage {
    ...
    private static final String VERIFY_MATLAB_INVOKES_POSITIVE = "Verify.matlab.invokes.positive";
    private static final String VERIFY_BUILD_IGNORES_TEST_FAILURE = "Verify.build.ignore.test.failure";
    private static final String CONFIG_FILE = "testconfig";
